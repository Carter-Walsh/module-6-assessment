...
describe("Adding X and O to different spots", () => {

    test("I can click the top left corner and add an X", async () => {
    ...
    test("The computer will add O to cell-1 after user clicks in cell-0", async () => {
        let cell1 = await driver.findElement(By.id("cell-1"));
        let cell1Text = await cell1.getText();
        expect(cell1Text).toBe("O");
    });

    test("I can click the top right corner and add an X", async () => {
    ...
    test("The computer will add O to cell-3 after user clicks in cell-2", async () => {
    ...
    test("I can click the bottom right corner and add an X", async () => {
